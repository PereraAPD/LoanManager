...
<head>
    ...
    <title>Green Loan Dashboard</title>
        ...
        <div class="navbar" id="navbar">
            ...
            <li><a href="../ApplicationConsole.php"><i class="fas fa-home"></i>Home</a></li>
                <li class="has-submenu">
                    <a href="#">Approve</a>
                    <ul class="submenu">
<li><a href="#" onclick="loadContent('L10Approve1.php')">Approve 1</a></li>
<li><a href="#" onclick="loadContent('L10Approve2.php')">Approve 2</a></li>
<li><a href="#" onclick="loadContent('L10Approved.php')">Approved</a></li>
                    </ul>
                </li>
                <li><a href="#"onclick="loadContent('L10DUReport.php')">Daily Uploading Report</a></li>
                <li><a href="#"onclick="loadContent('L10RegForm.php')">Registration</a></li>
                <li class="has-submenu">
                    <a href="#">Reference</a>
                    <ul class="submenu">
                        <li><a href="#" onclick="loadContent('L10Ref_SoA.php')">S.O.A.</a></li>
                        <li><a href="#" onclick="loadContent('L10Ref_Sector.php')">Sector</a></li>
                        <li><a href="#" onclick="loadContent('L10Ref_Sec.php')">Security</a></li>
                        <li><a href="#" onclick="loadContent('L10Ref_LoanType.php')">Loan Type</a></li>
                        <li><a href="#" onclick="loadContent('L10Ref_EEA.php')">E.E.A.</a></li>
                    </ul>
                </li>
            </ul>
        </div>
...
<ul>
    ...
    <li><strong>Security:</strong> Manage security settings for accessing and submitting loan records.</li>
        ...
        <button onclick="window.location.href='../L01/L01.php'">General
            ...
            <button onclick="window.location.href='../L11/L11.php'">Home Sweet Home</button>
