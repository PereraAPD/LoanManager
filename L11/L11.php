...
<head>
    ...
    <title>Home Sweet Home Dashboard</title>
        ...
        <div class="navbar" id="navbar">
            ...
            <li><a href="../ApplicationConsole.php"><i class="fas fa-home"></i>Home</a></li>
                <li class="has-submenu">
                    <a href="#">Approve</a>
                    <ul class="submenu">
<li><a href="#" onclick="loadContent('L11Approve1.php')">Approve 1</a></li>
<li><a href="#" onclick="loadContent('L11Approve2.php')">Approve 2</a></li>
<li><a href="#" onclick="loadContent('L11Approved.php')">Approved</a></li>
                    </ul>
                </li>
                <li><a href="#"onclick="loadContent('L11DUReport.php')">Daily Uploading Report</a></li>
                <li><a href="#"onclick="loadContent('L11RegForm.php')">Registration</a></li>
                <li class="has-submenu">
                    <a href="#">Reference</a>
                    <ul class="submenu">
                        <li><a href="#" onclick="loadContent('L11Ref_Location.php')">Location</a></li>
                    </ul>
                </li>
            </ul>
        </div>
