        ...
        <div class="navbar" id="navbar">
            <ul>
                ...
                <li class="has-submenu">
                    <a href="#">Approve</a>
                    <ul class="submenu">
                    <li><a href="#" onclick="loadContent('L14Approve1.php')">Approve 1</a></li>
                <li><a href="#"onclick="loadContent('L14Approve2.php')">Approve 2</a></li>
                <li><a href="#"onclick="loadContent('L14Approved.php')">View Approved</a></li>
                    </ul>
                </li>
                <li><a href="#" onclick="loadContent('L14DUReport.php')">Daily Uploading Report</a></li>
                <li><a href="#" onclick="loadContent('L14RegForm.php')">Registration Form</a></li>
                <li class="has-submenu">
                    <a href="#">Reference</a>
                    <ul class="submenu">
                        <li><a href="#" onclick="loadContent('L14Ref_VehicleType.php')">Type of Vehicle</a></li>
                    </ul>
                </li>
            </ul>
        </div>
