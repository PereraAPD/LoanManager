        ...
        <div class="navbar" id="navbar">
            <ul>
                ...
                <li class="has-submenu">
                    <a href="#">Approve</a>
                    <ul class="submenu">
                    <li><a href="#" onclick="loadContent('L17Approve1.php')">Approve 1</a></li>
                <li><a href="#"onclick="loadContent('L17Approve2.php')">Approve 2</a></li>
                <li><a href="#"onclick="loadContent('L17Approved.php')">View Approved</a></li>
                    </ul>
                </li>
                <li><a href="#" onclick="loadContent('L17DUReport.php')">Daily Uploading Report</a></li>
                <li><a href="#" onclick="loadContent('L17RegForm.php')">Registration Form</a></li>
                <li class="has-submenu">
                    <a href="#">Reference</a>
                    <ul class="submenu">
                        <li><a href="#" onclick="loadContent('L17Ref_1.php')">1</a></li>
                        <li><a href="#" onclick="loadContent('L17Ref_2.php')">2</a></li>
                        <li><a href="#" onclick="loadContent('L17Ref_3.php')">3</a></li>
                    </ul>
                </li>
            </ul>
        </div>
