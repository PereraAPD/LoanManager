        ...
        <div class="navbar" id="navbar">
            ...
            <li><a href="../ApplicationConsole.php"><i class="fas fa-home"></i>Home</a></li>
                <li class="has-submenu">
                    <a href="#">Approve</a>
                    <ul class="submenu">
                <li><a href="#" onclick="loadContent('L9Approve1.php')">Approve 1</a></li>
                <li><a href="#" onclick="loadContent('L9Approve2.php')">Approve 2</a></li>
                <li><a href="#" onclick="loadContent('L9Approved.php')">Approved</a></li>
                    </ul>
                </li>
                <li><a href="#"onclick="loadContent('L9DUReport.php')">Daily Uploading Report</a></li>
                <li><a href="#"onclick="loadContent('L9RegForm.php')">Registration</a></li>
                <li class="has-submenu">
                    <a href="#">Reference</a>
                    <ul class="submenu">
                    <li><a href="#" onclick="loadContent('L9Ref_MediaEq.php')">Media Equipment</a></li>
                    <li><a href="#" onclick="loadContent('L9Ref_CorMedia.php')">Correspondent Media</a></li>
                        <li><a href="#" onclick="loadContent('L9Ref_Sec.php')">Security</a></li>
                    </ul>
                </li>
            </ul>
        </div>
