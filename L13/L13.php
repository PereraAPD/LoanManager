...
<head>
    ...
    <title>Rekawaranaya Dashboard</title>
        ...
        <div class="navbar" id="navbar">
            <ul>
                ...
                <li class="has-submenu">
                    <a href="#">Approve</a>
                    <ul class="submenu">
                    <li><a href="#" onclick="loadContent('L13Approve1.php')">Approve 1</a></li>
                <li><a href="#"onclick="loadContent('L13Approve2.php')">Approve 2</a></li>
                <li><a href="#"onclick="loadContent('L13Approved.php')">View Approved</a></li>
                    </ul>
                </li>
                <li><a href="#" onclick="loadContent('L13DUReport.php')">Daily Uploading Report</a></li>
                <li><a href="#" onclick="loadContent('L13RegForm.php')">Registration Form</a></li>
                <li class="has-submenu">
                    <a href="#">Reference</a>
                    <ul class="submenu">
                        <li><a href="#" onclick="loadContent('L13Ref_Criteria.php')">Criteria</a></li>
                        <li><a href="#" onclick="loadContent('L13Ref_Sec.php')">Security</a></li>
                    </ul>
                </li>
            </ul>
        </div>
