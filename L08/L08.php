        ...
        <div class="navbar" id="navbar">
            ...
            <li><a href="../ApplicationConsole.php"><i class="fas fa-home"></i>Home</a></li>
                <li class="has-submenu">
                    <a href="#">Approve</a>
                    <ul class="submenu">
                <li><a href="#" onclick="loadContent('L8Approve1.php')">Approve 1</a></li>
                <li><a href="#" onclick="loadContent('L8Approve2.php')">Approve 2</a></li>
                <li><a href="#" onclick="loadContent('L8Approved.php')">Approved</a></li>
                    </ul>
                </li>
                <li><a href="#"onclick="loadContent('L8DUReport.php')">Daily Uploading Report</a></li>
                <li><a href="#"onclick="loadContent('L8RegForm.php')">Registration</a></li>
                <li class="has-submenu">
                    <a href="#">Reference</a>
                    <ul class="submenu">
                        <li><a href="#" onclick="loadContent('L8Ref_SOA.php')">Status of Applicant</a></li>
                        <li><a href="#" onclick="loadContent('L8Ref_Sec.php')">Security</a></li>
                    </ul>
                </li>
            </ul>
        </div>
