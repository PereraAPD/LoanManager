        ...
        <div class="navbar" id="navbar">
            <ul>
                ...
                <li class="has-submenu">
                    <a href="#">Approve</a>
                    <ul class="submenu">
                    <li><a href="#" onclick="loadContent('L18Approve1.php')">Approve 1</a></li>
                <li><a href="#"onclick="loadContent('L18Approve2.php')">Approve 2</a></li>
                <li><a href="#"onclick="loadContent('L18Approved.php')">View Approved</a></li>
                    </ul>
                </li>
                <li><a href="#" onclick="loadContent('L18DUReport.php')">Daily Uploading Report</a></li>
                <li><a href="#" onclick="loadContent('L18RegForm.php')">Registration Form</a></li>
                <li class="has-submenu">
                    <a href="#">Reference</a>
                    <ul class="submenu">
                        <li><a href="#" onclick="loadContent('L18Ref_Sec.php')">1</a></li>
                        <li><a href="#" onclick="loadContent('L18Ref_Subject.php')">2</a></li>
                        <li><a href="#" onclick="loadContent('L18Ref_Grade.php')">3</a></li>
                    </ul>
                </li>
            </ul>
        </div>
